...
(function($) {
	...
	*/
	...
	$.extend(Timepicker.prototype, {
		...
		_injectTimePicker: function() {
			...
			if ($dp.find("div.ui-timepicker-div").length === 0 && o.showTimepicker) {
				var noDisplay = ' style="display:none;"',
					html = '<div class="ui-timepicker-div'+ (o.isRTL? ' ui-timepicker-rtl' : '') +'"><dl>' + '<dt class="ui_tpicker_time_label"' + ((o.showTime) ? '' : noDisplay) + '>' + o.t �d��U   �d��U                  �Z��U          ЯY��U  h�d��U           �d��U   @       �d��U          ;
		...
		*/
		_onSelectH �d��U   �d��U                  �Z��U          ЯY��U  h�d��U           �d��U   @       �d��U          inputEl = this.$input ? this.$input[0] : null;
			if (onSelect && inputEl) {
	...
	*/
	...
	$.datepicker._updateDatepicker = function(inst) {
		...
		//  �d��U   �d��U                  �Z��U          ЯY��U  h�d��U           �d��U   @       �d��U          if ($.datepicker._curInst && $.datepicker._curInst != inst && $.datepicker._datepickerShowing && $.datepicker._lastInput != input) {
			return;
		}
