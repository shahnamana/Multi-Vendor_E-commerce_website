...
class WCFM_Install {
	...
	function wcfm_create_tables() {
	  ...
	  $create_tables_query[] = "CREATE TABLE IF NOT EXISTS `" . $wpdb->prefix . "wcfm_messages_stat` (
		...
		$create_tables_query[] = "CREATE TABLE {$wpdb->prefix}wcfm_fbc_offline_messages (
   ...
   $create_tables_query[] =  "CREATE TABLE {$wpdb->prefix}wcfm_fbc_chat_rows (
   ...
   $create_tables_query[] = "CREATE TABLE {$wpdb->prefix}wcfm_fbc_chat_sessions (
   ...
   $create_tables_query[] = "CREATE TABLE {$wpdb->prefix}wcfm_fbc_chat_visitors (
															user_id           varchar(30)             NOT NULL    DEFAULT '',
